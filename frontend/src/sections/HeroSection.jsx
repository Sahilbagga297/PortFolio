...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative px-4 sm:px-6 lg:px-8 py-16 sm:py-20 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div ref={contentRef} className="space-y-8 lg:space-y-10">
            ...
            <div className={`fade-up ${contentInView ? 'is-visible' : ''}`} style={{ '--delay': 0 }}>
            ...
            <div className={`fade-up ${contentInView ? 'is-visible' : ''}`} style={{ '--delay': 1 }}>
            ...
            {/* Skills */}
            <div className={`fade-up ${contentInView ? 'is-visible' : ''}`} style={{ '--delay': 2 }}>
              <div className="space-y-4">
            ...
            {/* Call to Actions */}
            <div className={`fade-up ${contentInView ? 'is-visible' : ''}`} style={{ '--delay': 3 }}>
          ...
          <div ref={imageRef} className={`fade-up ${imageInView ? 'is-visible' : ''}`} style={{ '--delay': 0 }}>
