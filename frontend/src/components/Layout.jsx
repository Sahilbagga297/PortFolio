...
const Layout = ({ children }) => {
  return (
    <div className="relative flex flex-col min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900">
      {/* Animated Background Elements — pure CSS, no JS tracking */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Gradient orbs */}
        <div
          className="absolute w-[1000px] h-[1000px] bg-gradient-to-r from-gray-800/20 via-gray-700/15 to-gray-600/10 rounded-full blur-3xl"
          style={{
            top: '-25%',
            left: '-15%',
        ...
        />
        <div
          className="absolute w-[800px] h-[800px] bg-gradient-to-r from-gray-700/15 via-gray-600/12 to-gray-500/8 rounded-full blur-3xl"
          style={{
            bottom: '-20%',
            right: '-10%',
        ...
        />
        <div
          className="absolute w-[600px] h-[600px] bg-gradient-to-r from-gray-600/10 to-gray-500/8 rounded-full blur-2xl"
          style={{
            top: '45%',
            right: '15%',
